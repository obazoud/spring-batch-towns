...
@Page
public class BatchJobInstanceEdit {
    public EditAction action;
    public Messages messages;
    public EntityAction entity;
    public BatchJobInstanceEditForm form;
    public BatchJobInstanceEditTabs tabs;

    public static class BatchJobInstanceEditForm extends CustomWebElement {
        public IntegerInput id = new IntegerInput("form:id");
        public StringInput jobName = new StringInput("form:jobName");
        public StringInput jobKey = new StringInput("form:jobKey");
    };

    public static class BatchJobInstanceEditTabs extends CustomWebElement {
    };
}