...
@Named
@Singleton
public class BatchJobExecutionSeqGenerator {

    /**
     * Returns a new BatchJobExecutionSeq instance filled with random values.
     */
    public BatchJobExecutionSeq getBatchJobExecutionSeq() {
        BatchJobExecutionSeq batchJobExecutionSeq = new BatchJobExecutionSeq();

        // primary key column must be set manually
        batchJobExecutionSeq.setId(ValueGenerator.getUniqueLong());
