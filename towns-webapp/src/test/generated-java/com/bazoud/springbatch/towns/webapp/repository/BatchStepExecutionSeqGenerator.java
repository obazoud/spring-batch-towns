...
@Named
@Singleton
public class BatchStepExecutionSeqGenerator {

    /**
     * Returns a new BatchStepExecutionSeq instance filled with random values.
     */
    public BatchStepExecutionSeq getBatchStepExecutionSeq() {
        BatchStepExecutionSeq batchStepExecutionSeq = new BatchStepExecutionSeq();

        // primary key column must be set manually
        batchStepExecutionSeq.setId(ValueGenerator.getUniqueLong());
