...
@Page
public class BatchStepExecutionSeqEdit {
    public EditAction action;
    public Messages messages;
    public EntityAction entity;
    public BatchStepExecutionSeqEditForm form;
    public BatchStepExecutionSeqEditTabs tabs;

    public static class BatchStepExecutionSeqEditForm extends CustomWebElement {
        public IntegerInput id = new IntegerInput("form:id");
    };

    public static class BatchStepExecutionSeqEditTabs extends CustomWebElement {
    };
}