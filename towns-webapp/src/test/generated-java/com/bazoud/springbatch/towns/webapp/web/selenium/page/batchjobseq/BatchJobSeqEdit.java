...
@Page
public class BatchJobSeqEdit {
    public EditAction action;
    public Messages messages;
    public EntityAction entity;
    public BatchJobSeqEditForm form;
    public BatchJobSeqEditTabs tabs;

    public static class BatchJobSeqEditForm extends CustomWebElement {
        public IntegerInput id = new IntegerInput("form:id");
    };

    public static class BatchJobSeqEditTabs extends CustomWebElement {
    };
}