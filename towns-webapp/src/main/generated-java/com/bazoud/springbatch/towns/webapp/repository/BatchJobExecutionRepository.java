...
/**
 * {@link GenericRepository} for {@link BatchJobExecution} 
 */
@Named
@Singleton
public class BatchJobExecutionRepository extends GenericRepository<BatchJobExecution, Long> {

    public BatchJobExecutionRepository() {
        super(BatchJobExecution.class);
    }

    @Override
    public BatchJobExecution getNew() {
        return new BatchJobExecution();
    }

    @Override
    public BatchJobExecution getNewWithDefaults() {
